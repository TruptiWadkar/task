...
wd = webdriver.Edge(executable_path="C:\\Users\\LENOVO\\Documents\\Downloads\\edgedriver_win64\\msedgedriver.exe")
print(wd.title)
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Trupti W')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('truptiwadkar08@gmail.com')
    time.sleep(3)
